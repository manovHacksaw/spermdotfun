...
const MIGRATION_SQL = [
  ...
  `,
  `
  ALTER TABLE profile_settings ADD COLUMN IF NOT EXISTS referred_by TEXT;
  `,
  `
  ALTER TABLE profile_settings ADD COLUMN IF NOT EXISTS referral_earned NUMERIC(30, 9) NOT NULL DEFAULT 0;
  `,
  `
